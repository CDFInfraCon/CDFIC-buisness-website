...
import { FaArrowRight, FaAward, FaBuilding, FaProjectDiagram, FaUsers } from 'react-icons/fa';
        ...
        <div className="container mx-auto mt-16 bg-gray-300 h-auto p-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div className=" flex flex-col  p-6 rounded-lg  ">
                    ...
                    <h2 className="text-2xl text-gray-900 font-medium title-font mb-4">OUR LEADERSHIP</h2>
                    <p className="leading-relaxed text-base mb-4">Meet the dedicated leaders driving Rodic forward with their unparalleled experience and commitment to excellence.</p>
                ...
                <div className="work h-64 ">
                    <img className='w-full h-full object-cover ' src="https://images.unsplash.com/photo-1551721434-8b94ddff0e6d?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1yZWxhdGVkfDd8fHxlbnwwfHx8fA%3D%3D&auto=format&fit=crop&w=600&q=60"
                        alt="" />
                    <div className="layer">
                        <h1 className='text-white font-extrabold'>Mr. Raj Kumar</h1>
                        <p className='text-white font-normal'>Chairman & Managing Director</p>
                ...
                <div className="work h-64">
                    ...
                    <div className="layer">
                        ...
                        <p> Lorem ipsum dolor sit amet consectetur adipisicing elit. Dignissimos, deserunt ducim</p>
                        <div>
            ...
            <div className="container px-5 py-24 mx-auto">
                <div className="flex flex-col mb-12">
                    ...
                    <div className="flex flex-wrap sm:flex-row flex-col py-6 mb-2">
                        <h1 className="sm:w-2/5 text-gray-900 font-medium title-font text-2xl mb-2 sm:mb-0">Services Final Frontier</h1>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 ">
                    ...
                    <div className="p-2">
                        <div className="rounded-lg overflow-hidden shadow-lg transition-transform transform hover:scale-105 hover:shadow-2xl">
                            <img alt="content" className="object-cover object-center w-full h-48" src="https://plus.unsplash.com/premium_photo-1664547606209-fb31ec979c85?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" />
                            <div className="p-4">
                                <h2 className="text-xl font-medium title-font text-gray-900 mb-3">Shooting Stars</h2>
                                <p className="text-base leading-relaxed mb-3">Swag shoivdigoitch literally meditation subway tile tumblr cold-pressed. Gastropub street art beard dreamcatcher neutra, ethical XOXO lumbersexual.</p>
                                <p className="text-indigo-500 inline-flex items-center mt-3 cursor-pointer">Learn More
                    ...
                    <div className="p-2">
                        <div className="rounded-lg overflow-hidden shadow-lg transition-transform transform hover:scale-105 hover:shadow-2xl">
                            <img alt="content" className="object-cover object-center w-full h-48" src="https://plus.unsplash.com/premium_photo-1664547606209-fb31ec979c85?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" />
                            <div className="p-4">
                                <h2 className="text-xl font-medium title-font text-gray-900 mb-3">The Catalyzer</h2>
                                <p className="text-base leading-relaxed mb-3">Swag shoivdigoitch literally meditation subway tile tumblr cold-pressed. Gastropub street art beard dreamcatcher neutra, ethical XOXO lumbersexual.</p>
                                <p className="text-indigo-500 inline-flex items-center mt-3 cursor-pointer">Learn More
                                    <FaArrowRight className="ml-3 text-lg transition-transform duration-300 ease-in-out transform hover:translate-x-2 cursor-pointer" />
                                </p>
                    ...
                    <div className="p-2">
                        <div className="rounded-lg overflow-hidden shadow-lg transition-transform transform hover:scale-105 hover:shadow-2xl">
                            <img alt="content" className="object-cover object-center w-full h-48" src="https://plus.unsplash.com/premium_photo-1664547606209-fb31ec979c85?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" />
                            <div className="p-4">
                                <h2 className="text-xl font-medium title-font text-gray-900 mb-3">The 400 Blows</h2>
                                <p className="text-base leading-relaxed mb-3">Swag shoivdigoitch literally meditation subway tile tumblr cold-pressed. Gastropub street art beard dreamcatcher neutra, ethical XOXO lumbersexual.</p>
                                <p className="text-indigo-500 inline-flex items-center mt-3 cursor-pointer">Learn More
                                    <FaArrowRight className="ml-3 text-lg transition-transform duration-300 ease-in-out transform hover:translate-x-2 cursor-pointer" />
                                </p>
                    ...
                    <div className="p-2">
                        <div className="rounded-lg overflow-hidden shadow-lg transition-transform transform hover:scale-105 hover:shadow-2xl">
                            <img alt="content" className="object-cover object-center w-full h-48" src="https://plus.unsplash.com/premium_photo-1664547606209-fb31ec979c85?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" />
                            <div className="p-4">
                                <h2 className="text-xl font-medium title-font text-gray-900 mb-3">The New Frontier</h2>
                                <p className="text-base leading-relaxed mb-3">Swag shoivdigoitch literally meditation subway tile tumblr cold-pressed. Gastropub street art beard dreamcatcher neutra, ethical XOXO lumbersexual.</p>
                                <p className="text-indigo-500 inline-flex items-center mt-3 cursor-pointer">Learn More
                                    <FaArrowRight className="ml-3 text-lg transition-transform duration-300 ease-in-out transform hover:translate-x-2 cursor-pointer" />
                                </p>
